...
<html lang="en">
<head>
<title>Warehouse Supplier Receiving Request</title>
...
<?php
    ...
    $query = "SELECT * FROM Message WHERE receiver_id ='$ws_id'";
    ...
    <div class="container">
      <div class="card">
      <div class="card-header"><b><?php echo $row['sender_id']; ?></b></div>
      <div class="card-body"><?php echo $row['item_name']; ?></div> 
      <div class="card-footer"><?php echo $row['quantity'] ?><span style="float: right"><?php echo $row['msg_date']; ?></span></div>
  </div>
